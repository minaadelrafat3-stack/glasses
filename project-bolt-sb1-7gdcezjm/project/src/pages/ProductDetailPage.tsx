...
export function ProductDetailPage() {
  ...
  const specs = [
    { label: 'Shape', value: product.shape.charAt(0).toUpperCase() + product.shape.slice(1) },
    { label: 'Material', value: product.material.charAt(0).toUpperCase() + product.material.slice(1) },
    ...
    { label: 'Frame Size', value: variant.sizeMm ? `${variant.sizeMm}mm` : 'One size' },
        ...
        <div className="grid gap-8 md:grid-cols-2 md:gap-12">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-5 flex items-baseline gap-3">
              <span className="text-2xl font-semibold text-ink-900">{formatMoney(variant.price)}</span>
              {onSale && (
                <span className="text-lg text-ink-400 line-through">{formatMoney(product.compareAtPrice!)}</span>
              )}
            </div>
            ...
            {/* Size info */}
            <div className="mt-6">
              <h3 className="mb-3 text-sm font-semibold text-ink-900">Frame size</h3>
              <div className="flex items-center gap-3 text-sm text-ink-600">
                <span className="rounded-lg bg-ink-100 px-3 py-1.5 font-medium">
                  {variant.sizeMm ? `${variant.sizeMm}mm` : 'One size'}
                </span>
